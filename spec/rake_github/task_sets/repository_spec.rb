...
describe RakeGithub::TaskSets::Repository do
  ...
  it 'adds all tasks in the provided namespace when supplied' do
    ...
    expect(Rake::Task.task_defined?('github:deploy_keys:provision'))
        .to(be(true))
    expect(Rake::Task.task_defined?('github:deploy_keys:destroy'))
        .to(be(true))
  ...
  context 'deploy keys tasks' do
    it 'adds all deploy key tasks in the provided namespace when supplied' do
      ...
      expect(Rake::Task.task_defined?('deployment_keys:provision'))
          .to(be(true))
      expect(Rake::Task.task_defined?('deployment_keys:destroy'))
          .to(be(true))
      expect(Rake::Task.task_defined?('deployment_keys:ensure'))
          .to(be(true))
    end
    ...
    context 'destroy task' do
      ...
      it 'uses the provided name when supplied' do
        ...
        expect(Rake::Task.task_defined?("deploy_keys:destroy_it_all"))
            .to(be(true))
      end
    ...
    context 'ensure task' do
      ...
      it 'uses the provided name when supplied' do
        ...
        expect(Rake::Task.task_defined?("deploy_keys:make_sure"))
            .to(be(true))
      end
