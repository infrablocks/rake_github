...
describe RakeGithub::TaskSets::Secrets do
  ...
  it 'adds all secrets tasks in the provided namespace ' \
     'when supplied' do
    define_tasks(namespace: :secrets)
  ...
  it 'adds all secrets tasks in the root namespace when none supplied' do
    define_tasks
